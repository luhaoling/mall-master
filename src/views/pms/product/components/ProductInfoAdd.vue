  ...
  <div style="margin-top: 50px">
    <el-form :model="value" :rules="rules" ref="productInfoForm" label-width="120px" style="width: 600px" size="small">
      ...
      <el-form-item label="商品相册：">
        <multi-upload v-model="value.images" @input="multiInput" key="images" :disabled="disabled"></multi-upload>
      </el-form-item>
      ...
      <el-form-item label="商品封面：">
        <multi-upload v-model="value.goodsFrontImage" :multiple='false' @input="multiInput3" :disabled="disabled" :maxCount='1' key="front-images"></multi-upload>
      </el-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      finishCommit() {
        ...
        this.value.categoryId=this.value.third_cate||this.value.second_cate||this.value.first_cate
