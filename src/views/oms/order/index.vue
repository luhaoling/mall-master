    ...
    <div class="table-container">
      <el-table ref="orderTable"
        ...
        <el-table-column label="联系电话" width="180" align="center">
          ...
          <template slot-scope="scope">{{scope.row.singerMobile}}</template>
        </el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      handleViewOrder(index, row){
        this.$router.push({path:'/oms/orderDetail',query:{orderSn:row.orderSn}})
      },
      ...
      getOrder(this.listQuery).then(response => {
        ...
        this.pageNum = this.listQuery.page;
        // 判断是否已经到达最后一页，如果是，则不再增加页码
