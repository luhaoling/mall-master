  ...
  <div class="detail-container">
    ...
    <el-card shadow="never" style="margin-top: 15px">
      <div class="operate-container">
        <i class="el-icon-circle-check-outline color-success" style="margin-left: 20px"></i>
        <span class="color-success">当前订单</span>
      ...
      <div class="table-layout">
        <el-row>
          ...
          <el-col :span="6" class="table-cell-title">下单日期</el-col>
        </el-row>
        <el-row>
          <el-col :span="6" class="table-cell">{{order.orderSn}}</el-col>
          <el-col :span="6" class="table-cell">{{order.userID}}</el-col>
          <el-col :span="6" class="table-cell">{{ formatDate(order.addTime) }}</el-col>
      ...
      <div class="table-layout">
        ...
        <el-row>
          <el-col :span="6" class="table-cell">{{order.signerName}}</el-col>
          <el-col :span="6" class="table-cell">{{order.phoneNumber}}</el-col>
          <el-col :span="6" class="table-cell">{{order.signerAddress}}</el-col>
        </el-row>
      </div>
      <div style="margin-top: 20px">
        <svg-icon icon-class="marker" style="color: #606266"></svg-icon>
      ...
      <el-table
        ...
        <el-table-column label="商品图片" width="120" align="center">
          <template slot-scope="scope">
            <img :src="scope.row.goodsImage" style="height: 80px">
          </template>
        </el-table-column>
...
<script>
  ...
  export default {
    ...
    created() {
      this.getOrderEach.orderID=this.$route.query.orderSn;
      console.log("订单id",this.getOrderEach.orderID);
      getOrderEach(this.getOrderEach).then(response => {
